...
public class MiniMapAreaDisplay extends Component {
	...
	public MiniMapAreaDisplay(MapDisplayAreaRedraw display) {
	...
	public void addDisplay(MapDisplayAreaRedraw control) {
		display = control;
