...
public class MapDisplayAreaRedraw extends Component {
	...
	protected MiniMapAreaDisplay miniControl;

	protected Rectangle viewPort = new Rectangle();
	protected Rectangle viewPortCells = new Rectangle();
	
	public MapDisplayAreaRedraw(DebsMap map) {
		this.map = map;

		DisplayMapAreaMouseControl mad = new DisplayMapAreaMouseControl(this);
	...
	public void addMiniControl(MiniMapAreaDisplay miniMapAreaDisplay) {
