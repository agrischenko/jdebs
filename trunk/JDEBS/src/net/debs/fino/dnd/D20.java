...
/**
 * –еализаци€ класа вычислени€ бросков кубиков по правилам D20
 * @author AAntonenko
 */
public class D20 {
	...
	/**
	 * ¬ычисление формулы системы D20 (в формуле можно исользовать числа, знаки "+","-" и обозначени€ типа "d2", "2d4" и т.д.)
	 * @param s формула дл€ вычислени€
	 * @return результат вычислени€ формулы
	 */
	...
	/**
	 * ќпредел€ет результат броска кубика с заданным количеством граней
